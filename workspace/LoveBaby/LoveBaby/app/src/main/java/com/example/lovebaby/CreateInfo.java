        ...
        savebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(alertBlank(name.getText().toString(),birthday.getText().toString(),birthtime.getText().toString()).equals("")){
                    ...
                    Toast.makeText(CreateInfo.this,alert+"을 입력하세요",Toast.LENGTH_SHORT).show();
                }
            }
        });
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful())
                        {
                            Toast.makeText(CreateInfo.this, "정보가 저장되었습나다.", Toast.LENGTH_SHORT).show();
                            ...
                            babyInfoDTO.imageUrl = downloadUrl.toString();
                            babyInfoDTO.name = name.getText().toString();
                            babyInfoDTO.sex = rb_sex.getText().toString();
                            babyInfoDTO.birthday = birthday.getText().toString();
                            babyInfoDTO.birthtime = birthtime.getText().toString();
                            babyInfoDTO.bloodtype = rb_blood.getText().toString();
                            babyInfoDTO.uid = auth.getCurrentUser().getUid();
                            babyInfoDTO.userId = auth.getCurrentUser().getEmail();
                            babyInfoDTO.imageName = file.getLastPathSegment();

                            database.getReference().child("babyinfo").push().setValue(babyInfoDTO);
